...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HUPhotoBrowser/HUPhotoBrowser.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QRCodeUIKit/QRCodeUIKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RITLKit/RITLKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RITLPhotos/RITLPhotos.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RITLViewFrame/RITLViewFrame.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/XHInputView/XHInputView.framework"
