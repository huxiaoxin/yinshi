...
- (void)viewDidLoad {
    ...
    FilmTopTitle.text=  @"关于5月3号橙子影视工厂维护公告";
    [self.view addSubview:FilmTopTitle];
    
    CGRect filmDetailRect = [@"尊敬的用户，您好～！\n因服务器升级需要，橙子影视工厂将于2021年5月3号服务器停机进行升级，届时app将无法访问大概有半个小时左右，还请大家稍安伪造等待一下，感谢各位的配合与支持，谢谢～" cxl_sizeWithMoreString:[UIFont systemFontOfSize:14] maxWidth:SCREEN_Width-K(20)];
