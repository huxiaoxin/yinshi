//
//  FilmFactoryComenmtNotiViewController.m
//  FilmFactory
//
...
@interface FilmFactoryComenmtNotiViewController ()
@property(nonatomic,strong) UITableView * FilmFacoryTableView;

@end

@implementation FilmFactoryComenmtNotiViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.gk_navTitle =  @"评论通知";
